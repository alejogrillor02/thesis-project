...
echo
echo "Doing statistical Tests on F and G with F test set"
./significance_test.py "${OUTPUT_DIR}/model_903/set_F/predictions/903_F_fold_metrics.csv" "${OUTPUT_DIR}/model_903/set_G/cross_eval/set_F/903_G_with_F_fold_metrics.csv"
echo
echo "Doing statistical Tests on M and G with M test set"
./significance_test.py "${OUTPUT_DIR}/model_903/set_M/predictions/903_M_fold_metrics.csv" "${OUTPUT_DIR}/model_903/set_G/cross_eval/set_M/903_G_with_M_fold_metrics.csv"
echo
